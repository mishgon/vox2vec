...
class MoCo(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            target_feature_pyramids_batch = self.momentum_backbone(target_images_batch, target_masks_batch)
            target_features = batched_take_features_from_pyramid(
                target_feature_pyramids_batch,
        ...
        context_feature_pyramids_batch = self.backbone(context_images_batch, context_masks_batch)
        context_features = batched_take_features_from_pyramid(
            context_feature_pyramids_batch,
